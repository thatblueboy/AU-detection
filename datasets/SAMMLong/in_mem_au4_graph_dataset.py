from datasets.SAMMLong.in_mem_graph_dataset import InMemoryGraphDataset

class AU4GraphDataset(InMemoryGraphDataset): #TODO use config file
    def __init__(self, device='cpu'):
        frames_path = "/media/thatblueboy/Seagate/LOP/data/SAMMLong/frames"
        labels_csv = "/media/thatblueboy/Seagate/LOP/data/SAMMLong/samm_long_cleaned.csv"
        ...
        super().__init__(frames_path, labels_csv, ROI_index, edges, (400, 400))